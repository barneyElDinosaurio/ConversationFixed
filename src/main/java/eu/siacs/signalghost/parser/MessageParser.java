package eu.siacs.signalghost.parser;
...
import eu.siacs.signalghost.crypto.OtrService;
...
import eu.siacs.signalghost.services.MessageArchiveService;
...
public class MessageParser extends AbstractParser implements OnMessagePacketReceived {
    ...
    private boolean DeleteChat(Account account, MessagePacket packet) {
        if (packet.getType() == MessagePacket.TYPE_ERROR) {
            Jid from = packet.getFrom();
            if (from != null) {
                Message message = mXmppConnectionService.markMessage(account,
    ...
    public void onMessagePacketReceived(Account account, MessagePacket original) {
        ...
        final boolean deleteCommand = packet.hasChild("DeleteCommand");
        ...
        if(deleteCommand){
            ...
            Intent broadcast = new Intent(ConversationActivity.ACTION_STATUS_DELETE);
            mXmppConnectionService.sendBroadcast(broadcast);
        }
    }
