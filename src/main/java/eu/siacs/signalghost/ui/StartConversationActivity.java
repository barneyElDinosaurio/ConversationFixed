...
import eu.siacs.signalghost.entities.ListItem;
...
import eu.siacs.signalghost.ui.adapter.ListItemAdapter;
...
public class StartConversationActivity extends XmppActivity implements OnRosterUpdate, OnUpdateBlocklist, ActionBar.TabListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        ab.getTabAt(1).select();



            ab.setDisplayHomeAsUpEnabled(false);

            ab.setCustomView(R.layout.header_image);
    ...
    protected void deleteConference() {
        ...
        builder.setMessage(getString(R.string.remove_bookmark_text,
                bookmark.getDisplayName())); //bookmark.getJid()
        builder.setPositiveButton(R.string.delete, new OnClickListener() {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem menuScanqrCode = menu.findItem(R.id.action_scan_qr_code);
        ...
        menuScanqrCode.setVisible(false);
    ...
    public void onTabUnselected(Tab tab, FragmentTransaction ft) {
        ...
        if(tab.getPosition() == 1) {
            //Intent o = new Intent(this,Conversation.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);

            //super.onBackPressed();
//            startActivity(o);
            //Intent previo = new Intent() ;
            //previo.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
            finish();
