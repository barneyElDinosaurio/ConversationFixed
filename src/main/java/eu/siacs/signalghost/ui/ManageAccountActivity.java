...
import eu.siacs.signalghost.ui.adapter.AccountAdapter;
...
public class ManageAccountActivity extends XmppActivity implements OnAccountUpdate, KeyChainAliasCallback, XmppConnectionService.OnAccountCreated {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        menu.findItem(R.id.mgmt_account_announce_pgp).setVisible(false);
        menu.setHeaderTitle(this.selectedAccount.getJid().getLocalpart().toString()); //this.selectedAccount.getJid().toBareJid().toString()
